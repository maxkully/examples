...
import {translate} from "../protein-translation/protein-translation";
...
describe('Space Age', () => {
  ...
  test('error when unknown planet', () => {
    expect(() => age('pluto', 1821023456)).toThrow(new Error('Unknown planet'));
  });

  test('error when invalid age', () => {
    expect(() => age('neptune', 'a1821023456')).toThrow(new Error('Invalid age in seconds'));
  });
});
